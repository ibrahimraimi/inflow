...
export function PricingSection() {
  ...
  return (
    <Layout className="py-2 md:py-2 lg:py-2 px-0">
      ...
      <section className="mx-auto grid w-full gap-4 md:grid-cols-2 xl:grid-cols-4">
        {plans.map((plan, index) => (
          <PricingCard.Card
            className={cn(
              "w-full max-w-full",
              index === 1 && "xl:scale-105 xl:shadow-xl xl:z-10",
            )}
            key={plan.name}
          >
            <PricingCard.Header>
