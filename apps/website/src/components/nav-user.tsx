  ...
  if (isMobile) {
    return (
      <div className="flex flex-col gap-2">
        ...
        {/* Navigation Items */}
        <Link href={`${siteConfig.dashboardUrl}/dashboard`}>
        ...
        <Link href={`${siteConfig.dashboardUrl}/dashboard/settings`}>
          <Button variant="ghost" className="w-full justify-between">
            <span>Settings</span>
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
        ...
        <DropdownMenuSeparator />
        <DropdownMenuGroup>
          <DropdownMenuItem onClick={() => window.location.href = `${siteConfig.dashboardUrl}/dashboard`}>
            Dashboard
            <DropdownMenuShortcut>⇧⌘P</DropdownMenuShortcut>
          </DropdownMenuItem>
          <DropdownMenuItem onClick={() => window.location.href = `${siteConfig.dashboardUrl}/dashboard/settings`}>
            Settings
